...
function Navbar() {
  ...
  return (
    <>
      ...
      <nav className={scroll ? "sticky" : "header"}>
        <div className='container'>
          <div className='inner'>
            ...
            {button  && <Button buttonStyle='btn--primary' buttonSize='btn--medium' text='Sign Up' />}
            </div>
          </div>
        </div>
      </nav>
